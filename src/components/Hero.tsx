    ...
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-white">
        ...
        <div className="flex flex-col sm:flex-row gap-4 animate-slide-up-delayed">
          <button className="group px-8 py-4 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-sm transition-all duration-300 flex items-center gap-2 hover:scale-105 shadow-lg">
            Plan Your Trip
            <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
          </button>
          <button className="px-8 py-4 bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white font-semibold rounded-sm transition-all duration-300 border border-white/30 hover:scale-105 shadow-lg">
